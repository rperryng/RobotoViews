...
/**
 * An extended {@link RadioButton} that uses the desired Roboto font
 * 
...
public class RobotoRadioButton extends RadioButton {
    ...
    /**
     * Use this constructor when creating a {@link RobotoRadioButton}
     * programmatically
     * 
     * @param context
     * @param robotoFont
     */
    public RobotoRadioButton(Context context, RobotoFont robotoFont) {
        super(context);
